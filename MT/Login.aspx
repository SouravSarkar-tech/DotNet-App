                                            ...
                                            <div>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                    <tr>
                                                        ...
                                                        <td height="24" align="right" valign="top" style="border-bottom: 1px #e4e3e3 solid">
                                                            <img src="images/lock_admin.jpg" alt="" />
                                                        </td>
                                                    </tr>
                                                    
                                                    <tr align="center">
                                                        <td height="40" valign="bottom" colspan="3" style="font-weight:bolder; color:Blue">
                                                            Thank you for Using Master WorkFlow Tool.
                                                        </td>
                                                    </tr>
                                                    <tr align="center">
                                                        <td height="40" >
                                                            <%--<asp:HyperLink ID="hypLoginAgain" runat="server" Text="Sign In Again" Font-Bold="true" NavigateUrl="~/Default.aspx"></asp:HyperLink>--%>
                                                            <asp:HyperLink ID="hypLoginAgain" runat="server" Text="Sign In Again" Font-Bold="true" NavigateUrl="~/PassLogin.aspx"></asp:HyperLink>
                                                        </td>
                                                        <td height="40" >
                                                            <asp:HyperLink ID="hypLoginUser" runat="server" Text="Sign As User" Font-Bold="true" NavigateUrl="~/DefaultReq.aspx" Visible="false"></asp:HyperLink>
                                                        </td>
                                                        <td>
                                                            <asp:HyperLink ID="HypDiffLogin" runat="server" Text="Sign in as Different User" Font-Bold="true" NavigateUrl="~/PassLogindiff.aspx"></asp:HyperLink>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="150" valign="bottom" colspan="3" style="font-weight:bolder; color:Maroon">
                                                        </td>
                                                    </tr>
                                                </table>
