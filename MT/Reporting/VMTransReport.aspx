<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Common/MainMaster.master"
    AutoEventWireup="true" CodeFile="VMTransReport.aspx.cs" Inherits="Reports_VMTransReport" %>
        ...
        <tr>
            <td class="centerTD" colspan="4">
                ...
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                    ...
                    <LocalReport ReportPath="Reporting\MWTDetailReport.rdlc">
                        <DataSources>
                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="MWT_Detail_Report" />
                        </DataSources>
                    </LocalReport>
                </rsweb:ReportViewer>
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="lblUserId" DefaultValue="0" Name="UserId" PropertyName="Text"
                            Type="Decimal" />
                        <asp:ControlParameter ControlID="ddlMasterType" DefaultValue="0" Name="ModuleType"
