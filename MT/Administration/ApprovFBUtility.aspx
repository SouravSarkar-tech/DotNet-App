<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/MasterPage.master" AutoEventWireup="true"
    CodeFile="ApprovFBUtility.aspx.cs" Inherits="Administration_ApprovFBUtility" %>
                    ...
                    <tr>
                        <td align="left" valign="top" colspan="2">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td class="leftTD" style="width: 25%">Select Department
                                    ...
                                    <td class="rigthTD">
                                        ...
                                        <asp:RequiredFieldValidator ID="reqddlDepartment" runat="server" ControlToValidate="ddlDepartment"
                                            ValidationGroup="save" ErrorMessage="Please select Department Name." SetFocusOnError="true"
                                ...
                                <tr>
                                    ...
                                    <td class="rigthTD">
                                        <asp:DropDownList ID="ddlApproveBy" runat="server" AppendDataBoundItems="true">
                                            <asp:ListItem Text="Select" Value="" />
                                        </asp:DropDownList>
