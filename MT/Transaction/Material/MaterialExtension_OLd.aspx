<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Material/MaterialMasterPage.master"
    AutoEventWireup="true" CodeFile="MaterialExtension_OLd.aspx.cs" Inherits="Transaction_Material_MaterialExtension" %>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <Columns>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" Visible="true">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblMaterialExtensionId" runat="server" Text='<%# Eval("Material_Extension_Id") %>'
                                                Visible="false"></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:LinkButton ID="lnkSave" runat="server" Text="Add New" OnClick="lnkSave_Click" ValidationGroup="ExtnAdd"></asp:LinkButton>
                                            <asp:Label ID="lblMaterialExtensionIdf" runat="server" Text="0" Visible="false"></asp:Label>
                                        </FooterTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Material Code">
                                        <ItemTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="reqtxtMaterialCode" runat="server" ControlToValidate="txtMaterialCode"
                                                ValidationGroup="Extn" ErrorMessage="Material Code cannot be blank."
                                        ...
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtMaterialCodef" runat="server" CssClass="textbox" MaxLength="10"
                                                AutoPostBack="true" TabIndex="1" Width="180" OnTextChanged="txtMaterialCodef_TextChanged" />
                                            <asp:RequiredFieldValidator ID="reqtxtMaterialCodef" runat="server" ControlToValidate="txtMaterialCodef"
                                                ValidationGroup="ExtnAdd" ErrorMessage="Material Code cannot be blank."
                                                SetFocusOnError="true" Display="Dynamic" Text="<img src='../../images/Error.png' title='Material Code cannot be blank.' />" />
                                            <asp:RegularExpressionValidator ID="regtxtMaterialCodef" runat="server" ControlToValidate="txtMaterialCodef"
                                                ValidationGroup="ExtnAdd" ErrorMessage="Material Code Invalid." SetFocusOnError="true"
                                                ValidationExpression="^[\d]{6,10}$" Display="Dynamic" Text="<img src='../../images/Error.png' title='Material Code Invalid.' />" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Material Code" Visible = "false">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddlMaterialAccGrp" runat="server" AppendDataBoundItems="false"
                                                Enabled="false" AutoPostBack="false" TabIndex="4">
                                        ...
                                        <FooterTemplate>
                                            <asp:DropDownList ID="ddlMaterialAccGrpf" runat="server" AppendDataBoundItems="false"
                                                Enabled="false" AutoPostBack="false" TabIndex="4">
                                                <asp:ListItem Text="Select" Value="0" />
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator ID="reqddlMaterialAccGrpf" runat="server" ControlToValidate="ddlMaterialAccGrpf"
                                                ValidationGroup="ExtnAdd" ErrorMessage="Select Material Type." SetFocusOnError="true"
                                                InitialValue="0" Display="Dynamic" Text="<img src='../../images/Error.png' title='Select Material Type.' />" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Material Description">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtMaterialDescription" runat="server" CssClass="textbox" MaxLength="40"
                                                Style="text-transform: uppercase" TabIndex="2" Width="200px" />
                                            <asp:RequiredFieldValidator ID="reqtxtMaterialDescription" runat="server" ControlToValidate="txtMaterialDescription"
                                                ValidationGroup="Extn" ErrorMessage="Material Description cannot be blank."
                                                SetFocusOnError="true" Display="Dynamic" Text="<img src='../../images/Error.png' title='Material Description cannot be blank.' />" />
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:TextBox ID="txtMaterialDescriptionf" runat="server" CssClass="textbox" MaxLength="40"
                                                Style="text-transform: uppercase" TabIndex="2" Width="200px" />
                                            <asp:RequiredFieldValidator ID="reqtxtMaterialDescriptionf" runat="server" ControlToValidate="txtMaterialDescriptionf"
                                                ValidationGroup="ExtnAdd" ErrorMessage="Material Description cannot be blank."
                                                SetFocusOnError="true" Display="Dynamic" Text="<img src='../../images/Error.png' title='Material Description cannot be blank.' />" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                    ...
                    <tr id="trButton" runat="server" visible="false">
                        <td class="centerTD" colspan="4">
                            ...
                            <asp:Button ID="btnSave" runat="server" ValidationGroup="Extn" Text="Save without Add" CssClass="button"
                                TabIndex="17" UseSubmitBehavior="true" OnClick="btnSave_Click" />
                            <asp:Button ID="btnNext" runat="server" ValidationGroup="Extn" Text="Proceed to Submit"
                                TabIndex="18" CssClass="button" OnClick="btnNext_Click" Width="160px" UseSubmitBehavior="true" />
