...
public partial class Transaction_Vendor_SAPIntegration : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // hyper.NavigateUrl = "http://localhost:50104/SAPIntegration.aspx?uid=" + Session[StaticKeys.LoggedIn_User_Id].ToString() + "&mid=" + Session[StaticKeys.MasterHeaderId].ToString();
