<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Common/MasterPage.master"
    ...
    CodeFile="ZcapHsnMaster.aspx.cs"
    Inherits="Transaction_ZcapHsnMaster_ZcapHsnMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <asp:Panel ID="pnlSearch" runat="server">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="leftTD" align="left">SAP Code</td>
                        <td class="rigthTD" align="left"> 
    ...
    <div id="divModulePopUp" style="display: none;" title="ZCAP/HSN Master">
        <asp:UpdatePanel ID="UpdModulePopUp" runat="server">
            <ContentTemplate>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td class="leftTD" width="25%">SBU
                        </td>
                        <td class="rigthTD">
                            <asp:DropDownList ID="ddlPlant" runat="server" AppendDataBoundItems="true">
                                <asp:ListItem Text="Select" Value="" />
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="rfvddlPlant" runat="server" ControlToValidate="ddlPlant"
                                ValidationGroup="next" ErrorMessage="Select Plant." SetFocusOnError="true"
