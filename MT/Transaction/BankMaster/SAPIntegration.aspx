<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SAPIntegration.aspx.cs" Inherits="Transaction_Vendor_SAPIntegration" %>
...
<body>
    ...
    <asp:GridView ID="grdSearch" runat="server" AutoGenerateColumns="false" Width="100%"
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="Vendor Account Group" DataField="msg" HeaderStyle-HorizontalAlign="Left"
