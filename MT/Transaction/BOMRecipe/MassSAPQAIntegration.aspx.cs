...
using System.Data;
using log4net;
public partial class Transaction_BOMRecipe_MassSAPQAIntegration : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            hyper.NavigateUrl = "../../SAPIntegration/MassSAPQAIntegration.aspx?uid=" + Session[StaticKeys.LoggedIn_User_Id].ToString() + "&mid=0&mrid=" + Session[StaticKeys.MassRequestProcessId].ToString();
