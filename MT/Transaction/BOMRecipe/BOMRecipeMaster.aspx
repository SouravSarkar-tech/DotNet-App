<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Common/MasterPage.master"
    AutoEventWireup="true" CodeFile="BOMRecipeMaster.aspx.cs" Inherits="Transaction_BOMRecipe_BOMRecipeMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <td colspan="4" class="tdSpace">
                            ...
                            <asp:GridView ID="grdSearch" runat="server" AutoGenerateColumns="false" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <%--BOM_NWF_SDT05072019--%>
                                       <asp:BoundField HeaderText="Prod. Version. Description / Recipe header Description" DataField="BomMaterial_Desc" HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-HorizontalAlign="Left">
                                        <HeaderStyle HorizontalAlign="Left" />
                                        <ItemStyle HorizontalAlign="Left" />
                                    </asp:BoundField>
                    ...
                    <tr>
                        <td colspan="4" class="tdSpace" align="right">
                            <asp:Button ID="btnDelete" runat="server" Text="Delete Request" CssClass="button" OnClick = "btnDelete_Click"
    ...
    <div id="divModulePopUp" title="BOM/Recipe Master" style="display: none;">
            ...
            <ContentTemplate>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td class="rigthTD">
                            ...
                            <asp:RequiredFieldValidator ID="reqddlModule" runat="server" ControlToValidate="ddlModule"
                                ValidationGroup="next" ErrorMessage="Select Creation Type." SetFocusOnError="true"
                                Display="Dynamic" Text="<img src='../../images/Error.png' title='Select Creation Type.' />" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="rigthTD">
                            <asp:DropDownList ID="ddlPlantType" runat="server" AppendDataBoundItems="true" AutoPostBack="true" 
                                OnSelectedIndexChanged="ddlPlantType_SelectedIndexChanged">                                
                                <asp:ListItem Text="Select" Value="" />
                                <asp:ListItem Text="API" Value="P" />
                                <asp:ListItem Text="Formulation" Value="F" />
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="reqddlPlantType" runat="server" ControlToValidate="ddlPlantType"
                                ValidationGroup="next" ErrorMessage="Select Plant Type." SetFocusOnError="true"
                                Display="Dynamic" Text="<img src='../../images/Error.png' title='Select Plant Type.' />" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdSpace" colspan="2">
    ...
    <div id="divModuleChangePopUp" title="BOM/Recipe Master Change" style="display: none;">
        <asp:UpdatePanel ID="UpdChangeModulePopUp" runat="server">
            <ContentTemplate>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="rigthTD">
                            <asp:DropDownList ID="ddlModuleC" runat="server" AppendDataBoundItems="true"> 
                                <asp:ListItem Text="Select" Value="" />
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="reqddlModuleC" runat="server" ControlToValidate="ddlModuleC"
                                ValidationGroup="change" ErrorMessage="Select Change Type." SetFocusOnError="true"
                                Display="Dynamic" Text="<img src='../../images/Error.png' title='Select Change Type.' />" />
                        </td>
                    </tr>
                    ...
                    <tr style="display: none">
                        ...
                        <td class="rigthTD">
                            ...
                            <asp:RequiredFieldValidator ID="reqddlPlantGroupC" runat="server" ControlToValidate="ddlPlantGroupC"
                                ValidationGroup="change" ErrorMessage="Select Plant Group." SetFocusOnError="true"
                                Display="Dynamic" Text="<img src='../../images/Error.png' title='Select Plant Group.' />" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="rigthTD">
                            <asp:DropDownList ID="ddlPlantTypeC" runat="server" AppendDataBoundItems="true" AutoPostBack="true" 
                                OnSelectedIndexChanged="ddlPlantTypeC_SelectedIndexChanged">                                
                                <asp:ListItem Text="Select" Value="" />
                                <asp:ListItem Text="API" Value="P" />
                                <asp:ListItem Text="Formulation" Value="F" />
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="reqddlPlantTypeC" runat="server" ControlToValidate="ddlPlantTypeC"
                                ValidationGroup="change" ErrorMessage="Select Plant Type." SetFocusOnError="true"
                                Display="Dynamic" Text="<img src='../../images/Error.png' title='Select Plant Type.' />" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="rigthTD">
                            ...
                            <asp:RequiredFieldValidator ID="reqddlPlantC" runat="server" ControlToValidate="ddlPlantC"
                                ValidationGroup="change" ErrorMessage="Select Plant." SetFocusOnError="true" Display="Dynamic"
                                Text="<img src='../../images/Error.png' title='Select Plant.' />" />
                        </td>
                    </tr>
                    <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="centerTD" colspan="2">
                    <asp:Button ID="btnChangeBulkRequest" runat="server" ValidationGroup="change" Text="Change Request" CssClass="button"
    ...
    <div id="divModulePopUpCopy" title="BOM Recipe Master - Copy" style="display: none;">
            ...
            <ContentTemplate>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        ...
                        <td class="rigthTD">
                            ...
                            <asp:RequiredFieldValidator ID="reqddlModuleCopy" runat="server" ControlToValidate="ddlModuleCopy"
                                ValidationGroup="Copy" ErrorMessage="Select Creation Type." SetFocusOnError="true"
                                Display="Dynamic" Text="<img src='../../images/Error.png' title='Select Creation Type.' />" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="rigthTD">
                            <asp:DropDownList ID="ddlPlantTypeCopy" runat="server" AppendDataBoundItems="true" AutoPostBack="true" 
                                OnSelectedIndexChanged="ddlPlantTypeCopy_SelectedIndexChanged">                                
                                <asp:ListItem Text="Select" Value="" />
                                <asp:ListItem Text="API" Value="P" />
                                <asp:ListItem Text="Formulation" Value="F" />
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="reqddlPlantTypeCopy" runat="server" ControlToValidate="ddlPlantTypeCopy"
                                ValidationGroup="Copy" ErrorMessage="Select Plant Type." SetFocusOnError="true"
                                Display="Dynamic" Text="<img src='../../images/Error.png' title='Select Plant Type.' />" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="rigthTD">
                            <asp:DropDownList ID="ddlPlantCopy" runat="server" AppendDataBoundItems="true">
                                <%--AutoPostBack="true" OnSelectedIndexChanged="ddlPlant_SelectedIndexChanged"--%>
                                <asp:ListItem Text="Select" Value="" />
                            </asp:DropDownList>
    ...
    <div id="divBOMRecipeBlockPopup" title="BOM Recipe Master :: Block / Unblock" style="display: none;">
        <asp:UpdatePanel ID="UpdBOMRecipeBlock" runat="server">
            <ContentTemplate>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr style="display: none">
                        <td class="leftTD" width="25%">
                        ...
                        <td class="rigthTD">
                            ...
                            <asp:RequiredFieldValidator ID="reqddlPlantGroupB" runat="server" ControlToValidate="ddlPlantGroupB"
                                ...
                                ValidationGroup="BOMRecipeBlock" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdSpace" colspan="2">
                    ...
                    <tr>
                        ...
                        <td class="rigthTD">
                            <asp:DropDownList ID="ddlPlantTypeB" runat="server" AppendDataBoundItems="true" AutoPostBack="true" 
                                OnSelectedIndexChanged="ddlPlantTypeB_SelectedIndexChanged">                                
                                <asp:ListItem Text="Select" Value="" />
                                <asp:ListItem Text="API" Value="P" />
                                <asp:ListItem Text="Formulation" Value="F" />
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="reqddlPlantTypeB" runat="server" ControlToValidate="ddlPlantTypeB"
                                ValidationGroup="BOMRecipeBlock" ErrorMessage="Select Plant Type." SetFocusOnError="true"
                                Display="Dynamic" Text="<img src='../../images/Error.png' title='Select Plant Type.' />" />
                        </td>
                    </tr>
                    <tr>                        
                        ...
                        <td class="rigthTD">
                            ...
                            <asp:RequiredFieldValidator ID="reqddlPlantB" runat="server" 
                                ControlToValidate="ddlPlantB" Display="Dynamic" ErrorMessage="Select Plant." SetFocusOnError="true" 
                                Text="&lt;img src='../../images/Error.png' title='Select Plant.' /&gt;" ValidationGroup="BOMRecipeBlock" />
                        </td>
                    <tr>
                        <td class="tdSpace" colspan="2">
                        </td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="centerTD" colspan="2">
                    <asp:Button ID="btnBlock" runat="server" ValidationGroup = "BOMRecipeBlock" Text="Block"
                        CssClass="button" OnClick="btnBlockRequest_Click" />
                    <asp:Button ID="btnUnBlock" runat="server" ValidationGroup="BOMRecipeBlock" Text="UnBlock"
    ...
    <asp:ValidationSummary ID="sm" runat="server" ValidationGroup="next" ShowMessageBox="true"
        ShowSummary="false" />
    <asp:ValidationSummary ID="bmrcpChange" runat="server" ValidationGroup="change" ShowMessageBox="true"
        ShowSummary="false" />
    <asp:ValidationSummary ID="ValidationSummary3" runat="server" ValidationGroup="Copy"
        ShowMessageBox="true" ShowSummary="false" />
    <asp:ValidationSummary ID="valbmrcpBloack" runat="server" ValidationGroup="BOMRecipeBlock" ShowMessageBox="true"
        ShowSummary="false" />
