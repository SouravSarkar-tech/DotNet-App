<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MassSAPValidation.aspx.cs" Inherits="Transaction_BOMRecipe_MassSAPValidation" %>
    ...
    <form id="form1" runat="server">
     ...
     <asp:GridView ID="grdSearch" runat="server" AutoGenerateColumns="false" Width="100%"
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="Validation Details" DataField="msg" HeaderStyle-HorizontalAlign="Left"
