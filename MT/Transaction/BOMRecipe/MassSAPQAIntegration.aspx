<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MassSAPQAIntegration.aspx.cs" Inherits="Transaction_BOMRecipe_MassSAPQAIntegration" %>
    ...
    <div>
     ...
     <asp:GridView ID="grdSearch" runat="server" AutoGenerateColumns="false" Width="100%"
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="Release Details" DataField="msg" HeaderStyle-HorizontalAlign="Left"
