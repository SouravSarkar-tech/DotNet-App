...
public partial class Transaction_Receipe_Reciepe : System.Web.UI.Page
{
    ...
    protected void GvOperation_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            helperAccess.PopuplateDropDownList(ddlAct_Operation_UoM, "proc_AutoComplete_Material_UOM '" + txtMaterialNo.Text.ToString() + "'", "LookUp_Desc", "LookUp_Code", "");
            ...
            helperAccess.PopuplateDropDownList(ddlChngeCUnit, "proc_AutoComplete_Material_UOM '" + txtMaterialNo.Text.ToString() + "'", "LookUp_Desc", "LookUp_Code", "");
            ...
            helperAccess.PopuplateDropDownList(ddlChngeOUnit, "proc_AutoComplete_Material_UOM '" + txtMaterialNo.Text.ToString() + "'", "LookUp_Desc", "LookUp_Code", "");
    ...
    protected void ddlSecResource_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            RecipeSecRes objSecRes = objRecipeAccess.GetDataByResourceName(ddlSecResource.SelectedValue, ddlPlant.SelectedValue);
    ...
    protected void grdMaterialHELP_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "MTRSELECT")
        {
            ...
            helperAccess.PopuplateDropDownList(ddlRheaderUnit, "proc_AutoComplete_Material_UOM '" + txtMaterialNo.Text.ToString() + "'", "LookUp_Desc", "LookUp_Code", "");
        ...
        try
        {
            if (objRecipeHeader.Recipe_HeaderID > 0)
            {
                ...
                if (dsOperation.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (Session[StaticKeys.SelectedModuleId].ToString() == "186")  //for API plants hide Standard Text column
                        GvOperation.Columns[9].Visible = false;
                    else if (Session[StaticKeys.SelectedModuleId].ToString() == "187")  //for API plants hide Standard Text column
    ...
    private RecipeDetail GetRcpDetailsControlValues()
    {
        ...
        objRcpDetails.Insp_Points = ddlInspPoints.SelectedValue;
        objRcpDetails.Partial_Lot = ddlPartialLot.SelectedValue;
        ...
        try
        {
            ...
            if (lstRow > 0)
            {
                for (int i = 0; i <= lstRow; i++)
                {
                    ...
                    //DT28072022 Start Comment
                    //if (objRecipeAccess.SaveOperationDetails(objRcpOperations) > 0)
                    //{
                    //    flg = true;
                    //}
                    //DT28072022 End Comment
                    //DT28072022 Start Added
    ...
    private void UpdatePICheckedState(int rowNo)
    {
        ...
        {
            lblDestination.Text = "";
            ddlIndicatorRelavancyToCosting.SelectedValue = "0";
        ...
        txtFirst_Std_Value.Enabled = flg;
        //txtFirst_Std_Value_Unit.Enabled = flg;
        txtSec_Std_Value.Enabled = flg;
        //txtSec_Std_Value_Unit.Enabled = flg;
        txtThird_Std_Value.Enabled = flg;
        //txtThird_Std_Value_Unit.Enabled = flg;
        ...
        else
        {
            ...
            //txtFirst_Std_Value_Unit.Text = objRcpOpStd.First_Std_Value_Unit;
            //txtSec_Std_Value_Unit.Text = objRcpOpStd.Sec_Std_Value_Unit;
            //txtThird_Std_Value_Unit.Text = objRcpOpStd.Third_Std_Value_Unit;
