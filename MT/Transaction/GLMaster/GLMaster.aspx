<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Common/MasterPage.master" AutoEventWireup="true" CodeFile="GLMaster.aspx.cs" Inherits="Transaction_GLMaster_GLMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlSearch" runat="server">
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td class="trHeading" align="center" colspan="4">GL Master
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="leftTD" align="left" style="width: 25%">G/L Code
                        </td>
                        <td class="rigthTD" align="left" style="width: 25%">
                    ...
                    <tr>
                        ...
                        <td class="rigthTD" align="left">
                            <asp:DropDownList ID="ddlGLAccGrp" runat="server" AppendDataBoundItems="true">
                            </asp:DropDownList>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" Visible="false">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblSelectedGLAccGrp" runat="server" Text='<%# Eval("SelectedVendorAccGrp") %>'></asp:Label>
                                    ...
                                    <asp:BoundField HeaderText="GL Acc. Grp" DataField="Module_Name" HeaderStyle-HorizontalAlign="Left"
                                        ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField HeaderText="GL" DataField="Name1" HeaderStyle-HorizontalAlign="Left"
                    ...
                    <tr>
                        <td align="left" colspan="4">
                            ...
                            <%-- OnClientClick="return ShowChangeDialog();" --%>
                            ...
                            <asp:Button ID="btnBlockRequest" runat="server" Text="GL Block / Unblock" CssClass="button"
                                Width="150px" Visible="true" OnClientClick="return ShowBlockDialog();" />
                            <asp:Button ID="btnChangeExtensionC" runat="server" Text="GL Extension" CssClass="button"
    ...
    <div id="divModulePopUp" style="display: none;" title="GL Master">
            ...
            <ContentTemplate>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="rigthTD">
                            <asp:DropDownList ID="ddlGLAccGroup" runat="server" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="ddlGLAccGroup_SelectedIndexChanged">
                                <asp:ListItem Text="Select" Value="" />
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlGLAccGroup"
                                ValidationGroup="next" ErrorMessage="Select GL Account Group." SetFocusOnError="true"
                                Display="Dynamic" Text="<img src='../../images/Error.png' title='Select GL Account Group.' />" />
                        </td>
                    </tr>
                    <tr>
                        <td class="tdSpace" colspan="2"></td>
                    ...
                    <tr>
                        <td class="leftTD" colspan="2">
                            <span style="color: Orange; font-size: x-small"><i>Note: Please select the correct
                                Account Group.</i><br />
    ...
    <div id="divChangeModulePopUp" style="display: none;" title="GL Master :: Block/Unblock">
        <asp:UpdatePanel ID="UpdChangePopup" runat="server">
            <ContentTemplate>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td class="leftTD" width="25%">GL Code
                        </td>
                        <td class="rigthTD">
                            ...
                            <asp:RegularExpressionValidator ID="regtxtGLCode" runat="server" ErrorMessage="Please check the SAP GL Code."
                                Text="<img src='../../images/Error.png' title='Please check the SAP GL Code.' />"
                                Display="Dynamic" ControlToValidate="txtGLCode" ValidationExpression="^[\S]{4,10}"
                                ValidationGroup="change"></asp:RegularExpressionValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="leftTD" width="25%">GL Name
                        </td>
                        <td class="rigthTD">
                            <asp:TextBox ID="txtGLName" runat="server" CssClass="textbox" MaxLength="60"
                                TabIndex="2" Width="180" />
                            <asp:RequiredFieldValidator ID="reqtxtGLName" runat="server" ControlToValidate="txtGLName"
                                ValidationGroup="change" ErrorMessage="GL Name cannot be blank." SetFocusOnError="true"
                    ...
                    <tr>
                        ...
                        <td class="rigthTD">
                            <asp:DropDownList ID="ddlGLAccGroupC" runat="server" AppendDataBoundItems="true" Enabled="false">
                                <asp:ListItem Text="Select" Value="" />
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="reqddlGLAccGroupC" runat="server" ControlToValidate="ddlGLAccGroupC"
                                ValidationGroup="change" ErrorMessage="Select GL Account Group." SetFocusOnError="true"
                                Display="Dynamic" Text="<img src='../../images/Error.png' title='Select GL Account Group.' />" />
                        </td>
                    </tr>
                    <tr>
                        <td class="leftTD" colspan="2">
                            <span style="color: Orange; font-size: x-small"><i>Note: Please select the correct GL
                                Account Group.</i><br />
                                <i>Once selected cannot be changed at later stage.</i></span>
                        </td>
                    </tr>
            ...
            <tr>
                <td class="centerTD" colspan="2">
                    <asp:Button ID="btnChange" runat="server" ValidationGroup="change" Text="Change"
                        CssClass="button" OnClick="btnChangeBulkRequest_Click" /><%----%>
    ...
    <div id="divGLExtPopup" title="GL Master :: Extension" style="display: none;">
        <asp:UpdatePanel ID="UpdGLPopup" runat="server">
            <ContentTemplate>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td class="tdSpace" colspan="2"></td>
                        <tr>
                            ...
                            <td class="rigthTD">
                                ...
                                <asp:RequiredFieldValidator ID="reqddlPlantC" runat="server" ControlToValidate="ddlPlantC"
                                    Display="Dynamic" ErrorMessage="Select Company Code." SetFocusOnError="true" Text="&lt;img src='../../images/Error.png' title='Select Company Code.' /&gt;"
                                    InitialValue="0" ValidationGroup="Extension" />
                            </td>
                        </tr>
                        <tr>
                            <td class="tdSpace" colspan="2"></td>
                        ...
                        <tr>
                            <td class="leftTD" colspan="2">
                                <span style="color: Orange; font-size: x-small"><i>Note: Please select the correct Company Code.</i><br />
                                    <i>Once selected cannot be changed at later stage.</i></span>
                            </td>
                        </tr>
                        <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="centerTD" colspan="2">
                    <asp:Button ID="btnChangeExtension" runat="server" Text="GL Extension" CssClass="button"
