<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Common/HomeMasterPage.master" AutoEventWireup="true" CodeFile="CallProsolAPI.aspx.cs" Inherits="Transaction_Common_CallProsolAPI" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlSearch" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td class="trHeading" align="center" colspan="4">Retrigger to Prosol Request 
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="centerTD" colspan="4">
                    <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="button"
                        ValidationGroup="prequest" OnClick="btnSearch_Click" />
                </td>
            </tr>
            <tr>
                <td colspan="4" class="tdSpace"></td>
                ...
                <td class="centerTD" colspan="4">
                    ...
                    <script type="text/javascript">
                        function CheckOtherIsCheckedByGVID(spanChk) {
                            ...
                            var Chk = spanChk;
                            Parent = document.getElementById("<%=grdReqDetails.ClientID%>");
                    ...
                    <asp:GridView ID="grdReqDetails" runat="server" AutoGenerateColumns="false" Width="100%"
                        BorderColor="#9D9D9D" EmptyDataText="No Data Found" AllowPaging="true" PageSize="10"
                        OnPageIndexChanging="grdReqDetails_PageIndexChanging" GridLines="Both">
                        ...
                        <Columns>
                            <%-- <asp:TemplateField HeaderText="Prosol ID" ItemStyle-CssClass="column_style_left"
                                ...
                                <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="column_style_right"
                                    ItemStyle-Width="90px">
                                    <ItemStyle CssClass="column_style_right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("sFlag")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            ...
                            <asp:BoundField HeaderText="Request Status" DataField="sFlag" HeaderStyle-HorizontalAlign="Left"
                                ItemStyle-HorizontalAlign="Left">
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="Remarks" ItemStyle-CssClass="column_style_right" 
                                ...
                                <ItemStyle CssClass="column_style_right" />
                                <ItemTemplate>
                                    <asp:TextBox ID="TxtRemarks" runat="server" Text='<%# Bind("sProsolRemarks") %>'></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Retrigger API" ItemStyle-CssClass="column_style_right"  
                                ItemStyle-HorizontalAlign="Center" ItemStyle-Width="90px">
                                <ItemStyle CssClass="column_style_right" />
                                <ItemTemplate>
                                     <asp:Button ID="BtnRetrigger" runat="server" Text="Retrigger"  OnClick="BtnRetrigger_Click"
                            ...
                            <asp:TemplateField HeaderText="Req Re-Create In MWT" ItemStyle-CssClass="column_style_right"  
                                ItemStyle-HorizontalAlign="Center" ItemStyle-Width="90px">
                                <ItemStyle CssClass="column_style_right" />
                                <ItemTemplate>
                                     <asp:Button ID="BtnCreateReqInMWT" runat="server" Text="Retrigger"  OnClick="BtnCreateReqInMWT_Click"
                                        CausesValidation="false"  />
                                    <%--<asp:RadioButton ID="rdoSelection" runat="server" GroupName="selection" AutoPostBack="true"
                                        onclick="javascript:CheckOtherIsCheckedByGVID(this);" OnCheckedChanged="rdoSelection_CheckedChanged" />--%>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                     <asp:Label ID="lblsFlag" runat="server" Text='<%# Eval("sFlag") %>'></asp:Label>
                                    <asp:Label ID="lblMWTID" runat="server" Text='<%# Eval("MWTID") %>'></asp:Label>
                                    <asp:Label ID="lblsProsolID" runat="server" Text='<%# Eval("sProsolID") %>'></asp:Label>
                                    <asp:Label ID="lblsSAPMatNumber" runat="server" Text='<%# Eval("sSAPMatNumber") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
