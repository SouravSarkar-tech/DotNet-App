<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucCustExtView.ascx.cs" Inherits="Transaction_UserControl_ucCustExtView" %>
<div style="width: 100%" class="leftTD">
    Import Data
</div>
<div align="right">
    <asp:HyperLink ID="hlImportFormat" runat="server" Text="Excel Format" Target="_blank"
        NavigateUrl="~/Transaction/Customer/UploadFormat/Customer Sales Master Format2.xlsx"></asp:HyperLink>
</div>
                ...
                <td class="tdSpace">
                    <asp:GridView ID="grvData1" runat="server" OnDataBound="grvData1_DataBound" AutoGenerateColumns="false">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Cust Account Grp">
                                <ItemTemplate>
                                    <asp:Label ID="lblCust_Account_Grp" runat="server" Text='<%# Eval("Cust_Account_Grp") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Panel ID="pnlMsg" runat="server">
                                       ...
                                       <asp:TextBox ID="txtCustomer_Code" runat="server" CssClass="textbox" MaxLength="70" Width="210" Visible="false"
                                        Text='<%# Eval("Customer_Code") %>' TabIndex="1" /> 
                                       <asp:TextBox ID="txtCustomer_Name" runat="server" CssClass="textbox" MaxLength="70" Width="210" Visible="false"
                                        Text='<%# Eval("Customer_Name" +
    "") %>' TabIndex="1" /> 

                                     <asp:DropDownList ID="ddlCompany_Code" runat="server" TabIndex="1" AppendDataBoundItems="false" AutoPostBack="true" Visible="false">
                                        <asp:ListItem Text="---Select---" Value=""></asp:ListItem>
                                    </asp:DropDownList>
                                     <asp:DropDownList ID="ddlCust_Account_Grp" runat="server" TabIndex="1" AppendDataBoundItems="false" AutoPostBack="true" Visible="false">
                                        <asp:ListItem Text="---Select---" Value=""></asp:ListItem>
                                    </asp:DropDownList>
