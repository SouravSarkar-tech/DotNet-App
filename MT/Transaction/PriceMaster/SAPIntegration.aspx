<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SAPIntegration.aspx.cs" Inherits="Transaction_PriceMaster_SAPIntegration" %>
...
<body>
    ...
    <asp:GridView ID="grdSearch" runat="server" AutoGenerateColumns="false" Width="100%"
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="Price Type" DataField="msg" HeaderStyle-HorizontalAlign="Left"
