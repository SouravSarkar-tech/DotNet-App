<%@ Page Title="" Language="C#" MasterPageFile="~/shared/Site.master" AutoEventWireup="true"
    CodeFile="ProfileModuleMapping.aspx.cs" Inherits="Pages_ProfileMenuMapping" %>
        ...
        <asp:UpdatePanel ID="updMain" runat="server">
            <ContentTemplate>
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td colspan="4">
                            <asp:GridView ID="gvModule" runat="server" AutoGenerateColumns="false" EmptyDataText="No Records"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Module Name" DataField="Module_Name" NullDisplayText="N\A" />
